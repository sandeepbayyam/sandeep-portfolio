        ...
        <>
            ...
            {active && (
                <motion.line
                    ...
                    style={{
                        filter:
                            "drop-shadow(0 0 10px rgba(255,92,0,.75))",
                    }}
                    initial={{
                        pathLength: 0,
                    }}
...
export default function EngineeringJourney() {
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            setActiveStep((prev) =>
                prev >= workflow.length - 1 ? 0 : prev + 1
            );
        }, 1300);
                    ...
                    >
                        <motion.div
                            ...
                            className={`
                                ...
                                transition-all
                                duration-700
                                ${node.id === "micro" ? "w-24 h-24" : "w-20 h-20"}
                                ...
                                ${isProduction
                                    ...
                                    : active
                                        ? `
                                            ...
                                            bg-primary/15
                                            text-primary
                                            shadow-[0_0_35px_rgba(255,92,0,.45)]
                                          `
                                        : completed
                                            ? `
                                            border-primary/60  
                                            bg-primary/5
                                            text-zinc-400
                                            shadow-[0_0_20px_rgba(255,92,0,.1)]
                                          `
                                            : `
                                            border-zinc-700/60
                                            bg-zinc-800/40
